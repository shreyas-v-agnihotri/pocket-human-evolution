...
struct Species {
    var scientificName: String                              // Scientific name
    ...
    var pinImage: UIImage                                   // Image to always use for this species' pins
...
// Defines different colors of map pins
enum MapPin: String {
    case red = "red-pin"
    case blue = "blue-pin"
    case green = "green-pin"
    case purple = "purple-pin"
    case yellow = "yellow-pin"
}

// Return map pin image for a given color
func image(mapPin: MapPin) -> UIImage {
    return UIImage(named: mapPin.rawValue)!.scaled(newSize: CGSize(width: 37.5, height: 52))
}
...
let humanSpecies: [String: Species] = [
    ...
    "Orrorin tugenensis": Species(
        scientificName: "Orrorin tugenensis",
        imageName: "Orrorin-tugenensis",
        existedFrom: 6.2,
        existedUntil: 5.8,
        pins: [(-6, 35)],
        pinImage: image(mapPin: .blue),
    ...
    "Ardipithecus kadabba": Species(
        scientificName: "Ardipithecus kadabba",
        imageName: "Ardipithecus-kadabba",
        existedFrom: 5.8,
        existedUntil: 5.2,
        pins: [(11, 40)],
        pinImage: image(mapPin: .green),
    ...
    "Ardipithecus ramidus": Species(
        scientificName: "Ardipithecus ramidus",
    ...
    "Australopithecus anamensis": Species(
        scientificName: "Australopithecus anamensis",
    ...
    "Kenyanthropus platyops": Species(
        scientificName: "Kenyanthropus platyops",
    ...
    "Paranthropus aethiopicus": Species(
        scientificName: "Paranthropus aethiopicus",
    ...
    "Australopithecus garhi": Species(
        scientificName: "Australopithecus garhi",
    ...
    "Paranthropus boisei": Species(
        scientificName: "Paranthropus boisei",
    ...
    "Australopithecus sediba": Species(
        scientificName: "Australopithecus sediba",
    ...
    "Homo rudolfensis": Species(
        scientificName: "Homo rudolfensis",
    ...
    "Homo erectus": Species(
        ...
        existedFrom: 1.89,
        existedUntil: 0.11,
        pins: [(-28, 24), (-3, 33), (13.5, 40.5), (43, 43.5), (27, 119), (-7, 107), (36, 119)],
        pinImage: image(mapPin: .yellow),
    ...
    "Paranthropus robustus": Species(
        scientificName: "Paranthropus robustus",
    ...
    "Homo sapiens 1": Species(
        ...
        moreInfo: "The species we all belong to \u{2014} modern humankind \u{2014} dates to 300,000 years ago in Africa. The first evidence of Homo sapiens outside of Africa is about 100,000 years ago, and in large swaths of Europe and Asia by 40,000 years ago, followed by spread to the Americas by 15,000 years ago. Our species is defined by a lighter build of the skeleton compared to earlier humans, with a large brain housed in a high-vaulted skull with a near-vertical forehead.",
        fossils: [
            Fossil(
                name: "Herto remains",
                type: "Skulls",
    ...
    "Homo sapiens 3": Species(
        scientificName: "Homo sapiens",
        imageName: "Homo-sapiens",
        existedFrom: 0.04,
        existedUntil: 0.0,
        pins: [(49, 13), (42, 80), (-25, 133)],
        pinImage: image(mapPin: .purple),
        geography: "Everywhere",
        brainSize: "~1350 cubic centimeters",
        moreInfo: "The species we all belong to \u{2014} modern humankind \u{2014} dates to 300,000 years ago in Africa. The first evidence of Homo sapiens outside of Africa is about 100,000 years ago, and in large swaths of Europe and Asia by 40,000 years ago, followed by spread to the Americas by 15,000 years ago. Our species is defined by a lighter build of the skeleton compared to earlier humans, with a large brain housed in a high-vaulted skull with a near-vertical forehead.",
